...
export const categoryBannersConfig: Record<string, CategoryBannersConfig> = {
  ...
  tech: {
    ...
    promoBanners: [
      {
        desktop: '/images/tech/promo_banner.jpg',
        tablet: '/images/tech/promo_banner_tablet.jpg',
        mobile: '/images/tech/promo_banner_mobile.jpg',
        link: '#',
        bannerId: 'promo-01',
      },
      {
        desktop: '/images/tech/promo_banner02.jpg',
        tablet: '/images/tech/promo_banner02_tablet.jpg',
        mobile: '/images/tech/promo_banner02_mobile.jpg',
        link: '#',
        bannerId: 'promo-02',
      },
    ],
    middleBanners: [
      {
        desktop: '/images/tech/middle_banner.jpg',
        tablet: '/images/tech/middle_banner_tablet.jpg',
        mobile: '/images/tech/middle_banner_mobile.jpg',
        link: '#',
        bannerId: 'middle',
      },
    ],
    smallBanners: [
      {
        image: '/images/tech/small_banner01.jpg',
        link: '#',
        bannerId: 'small-01',
      },
      {
        image: '/images/tech/small_banner02.jpg',
        link: '#',
        bannerId: 'small-02',
      },
      {
        image: '/images/tech/small_banner03.jpg',
        link: '#',
        bannerId: 'small-03',
      },
      {
        image: '/images/tech/small_banner04.jpg',
        link: '#',
        bannerId: 'small-04',
      },
      {
        image: '/images/tech/small_banner05.jpg',
        link: '#',
        bannerId: 'small-05',
      },
      {
        image: '/images/tech/small_banner06.jpg',
        link: '#',
        bannerId: 'small-06',
      },
      {
        image: '/images/tech/small_banner07.jpg',
        link: '#',
        bannerId: 'small-07',
      },
      {
        image: '/images/tech/small_banner08.jpg',
        link: '#',
        bannerId: 'small-08',
      },
      {
        image: '/images/tech/small_banner09.jpg',
        link: '#',
        bannerId: 'small-09',
      },
      {
        image: '/images/tech/small_banner10.jpg',
        link: '#',
        bannerId: 'small-10',
      },
    ],
  },
  // Add other categories here (kids)
};
