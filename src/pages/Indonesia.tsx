...
const Indonesia = () => {
  const handleShare = async () => {
    try {
      ...
      const shareData = {
        title: 'Indonesia Products - iNeed Stores',
        text: 'Check out these amazing Indonesia products from the world\'s biggest e-commerce platforms!',
        url: url,
      };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="text-center py-12">
        ...
        <div className="flex justify-center mt-12">
          <div className="w-[600px] max-w-[85%] md:w-[600px] h-[300px] rounded-lg p-8 flex flex-col justify-center" style={{ backgroundColor: '#dc2626' }}>
        ...
        <div className="text-center mt-8">
          <p className="font-omne-regular text-lg md:text-xl" style={{ color: '#dc2626' }}>
