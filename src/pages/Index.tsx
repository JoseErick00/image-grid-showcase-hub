    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="font-omne-medium text-2xl md:text-5xl text-foreground mb-6 max-w-[85%] mx-auto">
            We select the best products across all apps, making your search easier!
          </h1>
          <p className="font-omne-regular text-base md:text-xl text-muted-foreground max-w-[85%] mx-auto">
