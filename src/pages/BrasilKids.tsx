...
const BrasilKids = () => {
  ...
  usePageHints({
    ...
    borderColor: CATEGORY_COLORS.kids,
  });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-8">
        ...
        <div className="my-12">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-6 justify-center">
            <CategorySmallBanner
              image={smallBanner03}
              link="https://offer.alibaba.com/cps/0f4752f4?bm=cps&src=saf&productId=1601365537793"
              alt="Small banner 03"
              categorySlug="brasil-kids"
              bannerId="small-03"
              className="lg:h-[300px] lg:max-w-[540px] lg:mx-auto"
            ...
            <CategorySmallBanner
              image={smallBanner04}
              link="https://s.shopee.com.br/5L2yKb0AbP"
              alt="Small banner 04"
              categorySlug="brasil-kids"
              bannerId="small-04"
              className="lg:h-[300px] lg:max-w-[540px] lg:mx-auto"
        ...
        <div className="my-12">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-6 justify-center">
            <CategorySmallBanner
              image={smallBanner05}
              link="https://s.shopee.com.br/60IfAB4aC8"
              alt="Small banner 05"
              categorySlug="brasil-kids"
              bannerId="small-05"
              className="lg:h-[300px] lg:max-w-[540px] lg:mx-auto"
        ...
        <div className="my-12">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-6 justify-center">
            ...
            <CategorySmallBanner
              image={smallBanner08}
              link="https://offer.alibaba.com/cps/0f4752f4?bm=cps&src=saf&productId=1601257292412"
              alt="Small banner 08"
              categorySlug="brasil-kids"
              bannerId="small-08"
              className="lg:h-[300px] lg:max-w-[540px] lg:mx-auto"
          ...
          <div className="my-12 flex justify-center">
            <div className="w-full max-w-[1200px]">
              <CategoryPromoBanner
                ...
                link="https://amzn.to/3WprEJf"
                alt="Kids promo banner 02"
                categorySlug="brasil-kids"
                bannerId="promo-02"
              />
            </div>
